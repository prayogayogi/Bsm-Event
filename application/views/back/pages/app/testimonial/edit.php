	...
	<div class="page-title">
		<div class="row">
			<div class="col-12 col-md-6 order-md-1 order-last">
				...
				<p class="text-subtitle text-muted">Edit testimonial ini untuk mengupdate testimonial.</p>
			</div>
	...
	<section class="section">
		<div class="card">
			<div class="modal-body">
				<form action="<?= base_url('Admin/Testimonial/update/') . $index['id'];  ?>" method="post" enctype="multipart/form-data">
					<div class="row">
						<div class="col col-lg-12">
							...
							<div class="row">
								...
								<div class="col">
									<a href="http://" data-toggle="modal" data-backdrop="false" data-target="#detailFotoUpdate"><img src="<?= base_url('public/image/testimonial/') . $index['foto']; ?>" class="mt-4 mb-3 ml-3 img-thumbnail" alt="testimonial" width="70px"></a>
								</div>
							</div>
						</div>
						<div class="modal-footer mt-3 pt-3">
							<a href="<?= base_url('Admin/Testimonial') ?>" class="btn btn-secondary">
