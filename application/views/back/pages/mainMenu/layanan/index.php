	...
	<section class="section">
		<div class="card">
			<div class="card-header">
				<button type="button" class="btn btn-primary block" data-toggle="modal" data-backdrop="false" data-target="#backdrop">Tambah Data</button>
			</div>
			<div class="card-body">
					...
					<tbody>
						<?php foreach ($index as $indexs) : ?>
							<tr>
								...
								<td>
									<a href="<?= base_url('Admin/Layanan/edit/') . $indexs['slug']; ?>" class="btn btn-success"> <i data-feather="edit" width="5"></i></a>
									<a href="<?= base_url('Admin/Layanan/destroy/') . $indexs['slug']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus.?')" class="btn btn-danger"> <i data-feather="trash-2" width="5"></i></a>
								</td>
							</tr>
						<?php endforeach; ?>
					</tbody>
